...
Swal.fire({
  ...
  return (
    <>
  <h2 className="  text-xl lg:font-bold tracking-tight dark:text-white xs:text-md xs:font-medium -mt-12 py-6 px-80">ประวัติการซื้อ</h2>
...
<img srcSet="https://www.designil.com/wp-content/uploads/2022/02/prompt-pay-logo.jpg 2x" className="w-36 h-10 max-w-xl px-2 ml-2" alt="image" />


  <img className="h-40 max-w-xs" src={item.productqr} alt="image description" />
