...
const productDetail = () => {
  ...
  const loadData = async () => {
    const res = await axios.get(api + "product/" + productid).then((res) => {
      setdata(res.data)
    }).catch((error) => {
      console.log(error)
    })
    ...
    <>
      ...
      <section className="text-gray-700 body-font overflow-hidden bg-white  ">
        <div className="container px-4 py-10 mx-auto">
          ...
          <div className="modaldesc-img relative flex items-center justify-center lg:w-1/2 w-full object-cover object-center rounded border border-gray-200 ">
            <Image src={data.productimage} width={50} height={50} alt={data.productname} />
          </div>
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 className="text-sm title-font text-gray-500 tracking-widest">ddddd</h2>
